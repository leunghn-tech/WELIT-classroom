...
export default function EnglishSentenceRewriteActivity({ unit, onBack, onComplete }) {
  ...
  const retry = () => { setDraft(''); setFeedback(null); };
  const next = () => {
