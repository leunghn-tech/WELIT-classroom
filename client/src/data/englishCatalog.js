...
const englishCatalog = {
  ...
  P3: {
    ...
    summary: '小三先掌握規則與不規則過去式，再用代名詞、連接詞和數量詞擴展句子。',
    coreTopics: [
  ...
  P4: {
    ...
    summary: '小四由形容詞／副詞和比較級建立描述能力，再處理規則、反身代名詞、進階連接詞、將來式和數量詞；閱讀推論同步提升文本理解。',
    coreTopics: [
  ...
  P5: {
    ...
    summary: '小五先以現在完成式和時間線索處理經驗，再用過去進行式描述特定時刻的動作；以較長閱讀訓練理解與推論。',
    coreTopics: [
  ...
  P6: {
    ...
    summary: '小六先在條件句和間接引語中練習改寫，再以非謂語動詞、短語動詞和評估證據深化理解。',
    coreTopics: [
