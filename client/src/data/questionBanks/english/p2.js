  ...
  units: [
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'P2-EN-G01-Q09', prompt: '選出最合適的英文答案。', symbol: '🏃', sentence: 'Look! The boys ___ fast.', choices: ['are running', 'is running', 'run', 'runs'], answer: 'are running', explanation: 'Look! 表示現在正在發生；boys 是複數，用 are running。' },
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'P2-EN-G04-Q03', prompt: '選出最合適的英文答案。', symbol: '🚲', sentence: 'I am riding my bike. I ___ ride a bike.', choices: ['can', 'can’t', 'am', 'do'], answer: 'can', explanation: '正在騎單車證明有這項能力，用 can + 動詞原形。' },
        ...
        { id: 'P2-EN-G04-Q05', prompt: '選出最合適的英文答案。', symbol: '🎹', sentence: 'My sister plays the piano at the concert. She ___ play the piano.', choices: ['can', 'can’t', 'are', 'has'], answer: 'can', explanation: '在音樂會彈鋼琴證明她有這項能力，用 can。' },
        ...
        { id: 'P2-EN-G04-Q07', prompt: '選出最合適的英文答案。', symbol: '💬', sentence: 'Tom speaks English with his teacher. He ___ speak English.', choices: ['can', 'can’t', 'is', 'was'], answer: 'can', explanation: 'Tom 能用英語和老師交談，表示他有這項能力；can 後接動詞原形 speak。' },
        ...
        { id: 'P2-EN-G04-Q09', prompt: '選出最合適的英文答案。', symbol: '🏊', sentence: 'She swims across the pool. She ___ swim very well.', choices: ['can', 'can’t', 'is', 'has'], answer: 'can', explanation: '能游過泳池表示游泳能力很好，用 can。' },
