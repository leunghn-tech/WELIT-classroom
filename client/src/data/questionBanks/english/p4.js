...
const readingPassageSets = [
  {
    ...
    questions: [
      ...
      { id: 'P4-EN-R01-Q02', passageId: 'P4-EN-R01-P01', skill: 'detail', prompt: 'What did the students do before they planted anything?', answer: 'They removed small stones from the ground.', choices: ['They removed small stones from the ground.', 'They painted the library wall.', 'They picked vegetables for lunch.', 'They built a new classroom.'], explanation: 'The passage says the ground was full of small stones, so the students removed them first.' },
  ...
  units: [
    ...
    { id: 'P4-EN-G05', area: '句子連結', title: '時間、條件與轉折', objective: '用 when、if、although 連結較複雜的句子關係。', interaction: 'english-advanced-connector-choice', questions: makeQuestions('P4-EN-G05', [
      ...
      ['📕', 'I will read a book ___ I have time.', 'if', 'if|although|when|and', '表示有時間這個條件，用 if。'],
        ['🍽️', '___ you are ready to eat, wash your hands.', 'When', 'When|Although|If|Because', '表示準備進食時的時間關係，用 When。'],
