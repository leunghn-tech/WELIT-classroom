...
const readingPassageSets = [
  {
    ...
    questions: [
      ...
      { id: 'P5-EN-R01-Q04', passageId: 'P5-EN-R01-P01', skill: 'detail', prompt: 'What could pupils do after growing seeds from an envelope?', answer: 'Return new seeds later.', choices: ['Return new seeds later.', 'Pay the librarian.', 'Keep the envelope forever.', 'Plant only herbs.'], explanation: 'The passage explains that pupils could take an envelope, grow the seeds and return new seeds later.' },
...
const p5EnglishBank = {
  ...
  ].sort((left, right) => ['P5-EN-G01', 'P5-EN-G02', 'P5-EN-G06', 'P5-EN-G07', 'P5-EN-G03', 'P5-EN-G04', 'P5-EN-G05', 'P5-EN-S01', 'P5-EN-S02', 'P5-EN-R01'].indexOf(left.id) - ['P5-EN-G01', 'P5-EN-G02', 'P5-EN-G06', 'P5-EN-G07', 'P5-EN-G03', 'P5-EN-G04', 'P5-EN-G05', 'P5-EN-S01', 'P5-EN-S02', 'P5-EN-R01'].indexOf(right.id)),
};
