...
const p6EnglishBank = {
  ...
  units: [
    ...
    { id: 'P6-EN-G02', area: '間接引語', title: '把話轉述出來', objective: '把直接引語按人稱、時間詞及時態變化轉為間接引語。', interaction: 'english-reported-choice', questions: makeQuestions('P6-EN-G02', [
      ...
      ['🕘', 'Dad said, “The shop is closed today.” Dad said that the shop ___.', 'was closed that day', 'was closed that day|is closed today|had close that day|would close that day', '在這個有 today 的當時情境中，is 後退為 was，today 轉為 that day。'],
    ...
    { id: 'P6-EN-RW02', area: '間接引語', title: '間接引語改寫', objective: '把直接說話改寫為間接引語，處理人稱、時間詞和時態變化。', interaction: 'english-sentence-rewrite-reported', questions: [
      ...
      { id: 'P6-EN-RW02-Q05', prompt: '把直接說話改寫成間接引語。', instruction: '使用 Dad said that... 開始，留意 is 和 today 的變化。', source: 'Dad said, “The shop is closed today.”', focus: 'is → was；today → that day', placeholder: 'Dad said that ...', target: 'Dad said that the shop was closed that day.', hint: 'is 後退為 was；today 轉為 that day。', explanation: '這個當時的店舖狀態在轉述中用 was，today 轉為 that day。' },
