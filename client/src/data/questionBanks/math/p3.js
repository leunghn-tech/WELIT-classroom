...
const p3MathBank = {
  ...
  units: [
    { id: 'P3-MATH-A01', area: '數與代數', title: '五位數數線', objective: '在數線上認讀五位數，掌握千位及萬位數的相對位置。', interaction: 'math-number-line', questions: makeLine('P3-MATH-A01', [
      ['由左端向右跳兩個千，應點選哪個刻度？', 12000, 10000, 20000, 1000, '10,000 後第二個千是 12,000。'], ['這條數線正中間的刻度是哪一個？', 15000, 10000, 20000, 1000, '15,000 在 10,000 和 20,000 的中間。'], ['最接近右端、但比右端少 1 個千的位置是哪一個？', 19000, 10000, 20000, 1000, '19,000 比 20,000 少 1,000。'], ['從左端起向右數第三個千，應點選哪個刻度？', 23000, 20000, 30000, 1000, '20,000 後第三個千是 23,000。'], ['由左端向右數 5 個百，應點選哪個刻度？', 30500, 30000, 31000, 100, '30,500 比 30,000 多 500。'], ['由左端向右數第六個千，應點選哪個刻度？', 36000, 30000, 40000, 1000, '36,000 是 30,000 後第六個千。'], ['由左端再增加 2 個千的位置是哪一個？', 42000, 40000, 50000, 1000, '42,000 比 40,000 多 2,000。'], ['最接近右端、但向左退兩個百的位置是哪一個？', 50800, 50000, 51000, 100, '50,800 比 51,000 少 200。'], ['這條數線的正中間刻度是哪一個？', 65000, 60000, 70000, 1000, '65,000 在 60,000 和 70,000 的中間。'], ['這條數線最右端的刻度是哪一個？', 90000, 80000, 90000, 1000, '90,000 是這條數線最右邊的數。'],
    ]) },
    ...
    { id: 'P3-MATH-S02', area: '圖形與空間', title: '特殊四邊形', objective: '辨別平行四邊形、梯形和菱形的基本特徵。', interaction: 'math-choice', questions: makeChoice('P3-MATH-S02', [
      ['四條邊一樣長、形狀像斜斜的正方形，最可能是甚麼？', '菱形', ['長方形', '梯形', '菱形', '三角形'], '菱形的四條邊一樣長。'], ['只有一組對邊平行的四邊形，叫甚麼？', '梯形', ['正方形', '平行四邊形', '梯形', '菱形'], '梯形只有一組對邊平行。'], ['有兩組對邊平行的四邊形，叫甚麼？', '平行四邊形', ['平行四邊形', '梯形', '三角形', '圓形'], '平行四邊形有兩組對邊平行。'], ['平行四邊形的對邊怎樣？', '平行而且一樣長', ['全部相交', '平行而且一樣長', '只有一條邊', '沒有角'], '平行四邊形每組對邊平行並且等長。'], ['哪一個不是四邊形？', '三角形', ['梯形', '菱形', '平行四邊形', '三角形'], '三角形只有 3 條邊。'], ['梯形有多少組對邊平行？', '1 組', ['0 組', '1 組', '2 組', '4 組'], '梯形的特徵是只有 1 組對邊平行。'], ['哪一種圖形的四條邊都一樣長？', '菱形', ['梯形', '平行四邊形', '菱形', '長方形'], '菱形的四邊相等。'], ['菱形和正方形有甚麼相同特點？', '四條邊一樣長', ['都有 3 條邊', '四條邊一樣長', '沒有角', '只有一組平行邊'], '兩者都有四條相等的邊。'], ['平行四邊形最少有多少組平行邊？', '2 組', ['0 組', '1 組', '2 組', '4 組'], '兩組對邊都平行。'], ['哪一種圖形最像屋頂的側面？', '梯形', ['圓形', '梯形', '菱形', '球體'], '許多屋頂側面有一組平行的上下邊，像梯形。'],
    ]) },
    ...
    { id: 'P3-MATH-D01', area: '數據處理', title: '棒形圖一', objective: '讀取和解釋每格代表 1、2、5 或 10 個單位的簡單棒形圖資料。', interaction: 'math-choice', questions: makeChoice('P3-MATH-D01', [
      ['棒形圖中每格代表 1 人，足球有 6 格。喜歡足球的有多少人？', '6 人', ['1 人', '5 人', '6 人', '7 人'], '6 格 × 每格 1 人 = 6 人。'], ['每格代表 2 本書，閱讀組有 4 格。共有多少本書？', '8 本', ['4 本', '6 本', '8 本', '10 本'], '4 × 2 = 8。'], ['每格代表 5 人，紅隊有 3 格。紅隊有多少人？', '15 人', ['8 人', '10 人', '15 人', '20 人'], '3 × 5 = 15。'], ['每格代表 10 枝花，花園有 6 格。共有多少枝花？', '60 枝', ['16 枝', '50 枝', '60 枝', '70 枝'], '6 × 10 = 60。'], ['圖 A 有 5 格，圖 B 有 3 格，每格代表 2 個。相差多少個？', '4 個', ['2 個', '4 個', '6 個', '8 個'], '(5 − 3) × 2 = 4。'], ['每格代表 5 人，男生有 4 格，女生有 5 格。全班共有多少人？', '45 人', ['9 人', '20 人', '25 人', '45 人'], '(4 + 5) × 5 = 45。'], ['每格代表 10 元，收入有 8 格。收入是多少元？', '$80', ['$8', '$18', '$80', '$800'], '8 × 10 = 80。'], ['每格代表 2 支筆，A 組有 7 格。A 組有多少支筆？', '14 支', ['7 支', '9 支', '12 支', '14 支'], '7 × 2 = 14。'], ['圖表中最高的棒形代表哪一類？', '格數最多的一類', ['格數最少的一類', '格數最多的一類', '名字最長的一類', '顏色最深的一類'], '棒形越高（格數越多），代表數量越多。'], ['每格代表 5 個，水果有 6 格，文具有 2 格。水果比文具多多少個？', '20 個', ['4 個', '10 個', '20 個', '30 個'], '(6 − 2) × 5 = 20。'],
    ]) },
  ],
};
