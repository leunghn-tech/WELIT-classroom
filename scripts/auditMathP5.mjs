import p5 from '../client/src/data/questionBanks/math/p5.js';
...
console.log(JSON.stringify({ grade: p5.grade, subject: p5.subject, activeUnitCount: p5.units.length, questionsReviewed: questionIds.size, activeUnitIds: p5.units.map((unit) => unit.id), structuralFailures: failures }, null, 2));
